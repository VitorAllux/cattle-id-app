...
const CattleMessageModal: React.FC<CattleMessageModalProps> = ({
  cattleId,
  onClose,
  visible,
}) => {
  ...
  const [cattleVeterinarianId, setCattleVeterinarianId] = useState<
    number | null
  >(null);
  ...
  const cattleVeterinarianResource = useMemo(
    () => new CattleVeterinarianResource(),
    [],
  );
  ...
  useEffect(() => {
    const fetchCattleVeterinarian = async () => {
      try {
        const cattleVeterinarian =
          await cattleVeterinarianResource.getByCattleId(cattleId);
      ...
      if (cattleVeterinarianId) {
        try {
          const fetchedMessages =
            await cattleMessageResource.getMessagesByCattleVeterinarianId(
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            {hasCattleVeterinarian ? (
              ...
              <Text>
                Nenhum veterinário associado a este gado. O chat está
                desabilitado.
              </Text>
            )}
          </View>
